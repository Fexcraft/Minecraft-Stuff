...
public final class CE_Blocks{
	...
	public static class Clock2 extends CEBBC{
		...
		public Clock2(String name, String info) {super(name); this.info = info; GameRegistry.registerBlock(this, C2I.class, name);}
	...
	public static class Calendar1 extends CEBB{
		private static String info;
		public Calendar1(String name, String info) {super(name); this.info = info; GameRegistry.registerBlock(this, CL1I.class, name);}
		@Override public TileEntity createNewTileEntity(World worldIn, int meta) {return new TE();}
		public static class TE extends TileEntity{}
	...
	public static class Clock1C extends CEBB{
		private static String info;
		public Clock1C(String name, String info) {super(name); this.info = info; GameRegistry.registerBlock(this, C1CI.class, name);}
	...
	public static class Clock2C extends CEBBC{
		private static String info;
		public Clock2C(String name, String info) {super(name); this.info = info; GameRegistry.registerBlock(this, C2CI.class, name);}
		@Override public TileEntity createNewTileEntity(World worldIn, int meta) {return new TEC();}
		public static class TEC extends TileEntity{
			@Override
			public SPacketUpdateTileEntity getUpdatePacket(){
	...
	public static class Calendar1C extends CEBB{
		private static String info;
		public Calendar1C(String name, String info) {super(name); this.info = info; GameRegistry.registerBlock(this, CL1CI.class, name);}
	...
	public static class Clock3_W extends CEBB{
		private static String info;
		public Clock3_W(String name, String info) {super(name); this.info = info; GameRegistry.registerBlock(this, C3I.class, name);}
		@Override public TileEntity createNewTileEntity(World worldIn, int meta) {return new TE();}
		public static class TE extends TileEntity{}
	...
	public static class Clock3_B extends CEBB{
		private static String info;
		public Clock3_B(String name, String info) {super(name); this.info = info; GameRegistry.registerBlock(this, C3I.class, name);}
		@Override public TileEntity createNewTileEntity(World worldIn, int meta) {return new TE();}
		public static class TE extends TileEntity{}
		public static class C3I extends ItemBlock{
			public C3I(Block block){super(block);}
