package net.fexcraft.mod.extensions.ie.gui.server;
...
public class ContainerEF extends Container{
    ...
    public ContainerEF(InventoryPlayer playerInventory, IInventory furnaceInventory){
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 56, 35));
        this.addSlotToContainer(new SlotFurnaceFuel(furnaceInventory, 1, 37, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index){
        ...
        if(slot != null && slot.getHasStack()){
            ...
            if(index == 2){
                ...
                else if(Furnance1bEntity.isItemFuel(itemstack1)){
