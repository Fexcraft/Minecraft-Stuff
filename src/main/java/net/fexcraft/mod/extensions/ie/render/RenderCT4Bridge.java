...
public class RenderCT4Bridge extends TileEntitySpecialRenderer {
	
	public ModelCabelType4Bridge model;
	
	public RenderCT4Bridge() {
	...
	public void renderTileEntityAt(TileEntity TE, double posX, double posY, double posZ, float p_180535_8_, int p_180535_9_){
		...
		RenderUtil.renderLabel(TE, "FPU: " + te.fpu_get(EnumFacing.NORTH) + "[U] | " + te.fpu_get(EnumFacing.EAST) + "[D]", posX + 0.5, posY + 0.5, posZ + 0.5, 16, this.getFontRenderer(), rendererDispatcher);
    }
}