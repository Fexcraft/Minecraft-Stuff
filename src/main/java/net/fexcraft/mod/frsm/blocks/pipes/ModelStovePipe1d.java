...
public class ModelStovePipe1d extends ModelConverter {
	
	int textureX = 64;
	int textureY = 64;

	public ModelStovePipe1d(){
		...
		bodyModel[8].addShapeBox(0F, 0F, 0F, 1, 7, 1, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 0
		bodyModel[8].setRotationPoint(8F, 13.5F, -2.5F);
		bodyModel[8].rotateAngleZ = -1.57079633F;

		bodyModel[9].addBox(0F, 0F, 0F, 3, 7, 1, 0F); // Box 55
		bodyModel[9].setRotationPoint(8F, 14.5F, -2.5F);
		bodyModel[9].rotateAngleZ = -1.57079633F;

		bodyModel[10].addBox(0F, 0F, 0F, 3, 7, 1, 0F); // Box 56
		bodyModel[10].setRotationPoint(8F, 14.5F, 1.5F);
		bodyModel[10].rotateAngleZ = -1.57079633F;

		bodyModel[11].addBox(0F, 0F, 0F, 1, 7, 3, 0F); // Box 57
		bodyModel[11].setRotationPoint(8F, 13.5F, -1.5F);
		bodyModel[11].rotateAngleZ = -1.57079633F;

		bodyModel[12].addBox(0F, 0F, 0F, 1, 7, 3, 0F); // Box 58
		bodyModel[12].setRotationPoint(8F, 17.5F, -1.5F);
		bodyModel[12].rotateAngleZ = -1.57079633F;

		bodyModel[13].addShapeBox(0F, 0F, 0F, 1, 7, 1, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 59
		bodyModel[13].setRotationPoint(8F, 17.5F, -2.5F);
		bodyModel[13].rotateAngleZ = -1.57079633F;

		bodyModel[14].addShapeBox(0F, 0F, 0F, 1, 7, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F); // Box 60
		bodyModel[14].setRotationPoint(8F, 17.5F, 1.5F);
		bodyModel[14].rotateAngleZ = -1.57079633F;

		bodyModel[15].addShapeBox(0F, 0F, 0F, 1, 7, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F); // Box 61
