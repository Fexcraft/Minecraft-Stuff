...
public class Furnance1b extends FBC_4R {
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune){
        return Item.getItemFromBlock(FRSM_Blocks.furnace1);
    }
	...
	public static void setState(boolean active, World worldIn, BlockPos pos){
        ...
        if (active){
            worldIn.setBlockState(pos, FRSM_Blocks.furnace1b.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, FRSM_Blocks.furnace1b.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else{
            worldIn.setBlockState(pos, FRSM_Blocks.furnace1b.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state){
        if (!keepInventory){
            TileEntity tileentity = worldIn.getTileEntity(pos);
            if (tileentity instanceof Furnance1bEntity){
                InventoryHelper.dropInventoryItems(worldIn, pos, (Furnance1bEntity)tileentity);
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state){
        return new ItemStack(FRSM_Blocks.furnace1);
    }
}