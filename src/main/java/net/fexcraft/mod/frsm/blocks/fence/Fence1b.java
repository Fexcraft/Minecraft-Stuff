...
public class Fence1b extends FBC_4R {
	...
	public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos){
        ...
        if(enumfacing.equals(EnumFacing.NORTH)){
        	return new AxisAlignedBB(0.4F, 0.0F, 0.0F, 1.0F, 1.5F, 0.6F);
        }
        if(enumfacing.equals(EnumFacing.SOUTH)){
        	return new AxisAlignedBB(0.0F, 0.0F, 0.4F, 0.6F, 1.5F, 1.0F);
        }
        if(enumfacing.equals(EnumFacing.WEST)){
        	return new AxisAlignedBB(0.4F, 0.0F, 0.4F, 1.0F, 1.5F, 1.0F);
        }
        if(enumfacing.equals(EnumFacing.EAST)){
        	return new AxisAlignedBB(0.0F, 0.0F, 0.0F, 0.6F, 1.5F, 0.6F);
        }
        else{
