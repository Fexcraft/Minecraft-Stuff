...
public class FclConfig {
	...
	public static final void requestRemoval(){
		//TODO
	}
	...
	private static final void refresh(boolean f){
		...
		if(config.getBoolean("Remove from Database", "Statistics", false, "Set to 'true' if you want all data regarding your UUID to be removed from the Statistics Database.")){
			requestRemoval();
		}
