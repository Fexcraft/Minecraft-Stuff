...
public class BluePrintTable extends GuiContainer {
	...
	public static class HorizontalArrow extends GuiButton {
			...
			public void drawButton(Minecraft mc, int mouseX, int mouseY, float f){
				...
				if(this.enabled){
					if(this.hovered){
						this.drawTexturedModalRect(this.x, this.y, 122, left ? 232 : 244, this.width, this.height);
					}
					else{
						this.drawTexturedModalRect(this.x, this.y, 152, left ? 232 : 244, this.width, this.height);
					}
				}
				else{
					this.drawTexturedModalRect(this.x, this.y, 137, left ? 232 : 244, this.width, this.height);
				}
			}
		...
		public static class VerticalArrow extends GuiButton {
			...
			public void drawButton(Minecraft mc, int mouseX, int mouseY, float f){
				...
				if(this.enabled){
					if(this.hovered){
						this.drawTexturedModalRect(this.x, this.y, up ? 101 : 89, 211, this.width, this.height);
					}
					else{
						this.drawTexturedModalRect(this.x, this.y, up ? 101 : 89, 226, this.width, this.height);
					}
				}
				else{
					this.drawTexturedModalRect(this.x, this.y, up ? 101 : 89, 241, this.width, this.height);
				}
			}
		...
		public static class ComponentsScroll extends GuiButton {
			...
			public void drawButton(Minecraft mc, int mouseX, int mouseY, float f){
				...
				if(this.enabled){
					if(this.hovered){
						this.drawTexturedModalRect(this.x, this.y, 113, up ? 207 : 216, this.width, this.height);
					}
					else{
						this.drawTexturedModalRect(this.x, this.y, 149, up ? 207 : 216, this.width, this.height);
					}
				}
				else{
					this.drawTexturedModalRect(this.x, this.y, 131, up ? 207 : 216, this.width, this.height);
				}
			}
		}
		...
		public static class RecipeItem extends GuiButton {
			...
			public void drawButton(Minecraft mc, int mouseX, int mouseY, float f){
				...
				if(this.enabled){
					if(this.hovered){
						this.drawTexturedModalRect(this.x, this.y, 178, 207, this.width, this.height);
					}
					else if(this.selected){
						this.drawTexturedModalRect(this.x, this.y, 178, 225, this.width, this.height);
					}
					else{
						this.drawTexturedModalRect(this.x, this.y, 157, 19, this.width, this.height);
					}
				}
			}
		...
		public static class CraftButton extends GuiButton {
			...
			public void drawButton(Minecraft mc, int mouseX, int mouseY, float f){
				...
				if(this.enabled){
					if(table.craftable){
						if(this.hovered){
							this.drawTexturedModalRect(this.x, this.y, 41, 225, this.width, this.height);
						}
						else{
							this.drawTexturedModalRect(this.x, this.y, 23, 225, this.width, this.height);
						}
					}
					else{
						if(this.hovered){
							this.drawTexturedModalRect(this.x, this.y, 59, 225, this.width, this.height);
						}
						else{
							this.drawTexturedModalRect(this.x, this.y, 5, 225, this.width, this.height);
						}
					}
				}
				/*else{
