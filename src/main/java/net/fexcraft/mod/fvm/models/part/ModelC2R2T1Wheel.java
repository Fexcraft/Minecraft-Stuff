...
import net.fexcraft.mod.fvm.models.AdjustableWheelModel;
...
public class ModelC2R2T1Wheel extends AdjustableWheelModel {
	...
	@Override
	public void renderExchangeWheel(VehicleType data, String usedAS) {
		return;
	}
	...
	@Override
	public void renderExchangeWheel(VehicleType data, String usedAS, LandVehicle vehicle) {
		return;
	}

	@Override
	public void renderRightBack(VehicleType data, String usedAS, LandVehicle vehicle) {
	...
	@Override
	public void renderLeftBack(VehicleType data, String usedAS, LandVehicle vehicle) {
		GL11.glRotated(180, 0, 1, 0);
		for(ModelRendererTurbo model : wheels){
			model.rotateAngleZ = data.rotateWheels ? -vehicle.wheelsAngle : 0;
			model.render();
	...
	@Override
	public void renderRightFront(VehicleType data, String usedAS, LandVehicle vehicle) {
		for(ModelRendererTurbo model : wheels){
			model.rotateAngleZ = data.rotateWheels ? vehicle.wheelsAngle : 0;
			model.rotateAngleY = vehicle.wheelsYaw * Static.rad180 / 180F * 3F;
			model.render();
	...
	@Override
	public void renderLeftFront(VehicleType data, String usedAS, LandVehicle vehicle) {
		GL11.glRotated(180, 0, 1, 0);
		for(ModelRendererTurbo model : wheels){
			model.rotateAngleZ = data.rotateWheels ? -vehicle.wheelsAngle : 0;
			model.rotateAngleY = vehicle.wheelsYaw * Static.rad180 / 180F * 3F;
