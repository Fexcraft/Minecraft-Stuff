...
public class FvmUpdateHandler {
	
	private static JsonArray msg;
	private static Side side;
	
	public static void load(){
		JsonObject obj = Network.request("http://fexcraft.net/minecraft/fcl/request", "mode=requestdata&modid=fvm");
		JsonObject jsn = null;
	...
	public static void register(){
		if(msg != null && (side == null ? true : side == Static.side())){
			MinecraftForge.EVENT_BUS.register(new FvmUpdateHandler());
		}
	}
